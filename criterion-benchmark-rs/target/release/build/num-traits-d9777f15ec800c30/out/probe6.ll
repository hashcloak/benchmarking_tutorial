; ModuleID = 'probe6.607902569a071695-cgu.0'
source_filename = "probe6.607902569a071695-cgu.0"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128"
target triple = "arm64-apple-macosx11.0.0"

; core::f64::<impl f64>::is_subnormal
; Function Attrs: inlinehint uwtable
define internal zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17h89c3482fc679046dE"(double %self) unnamed_addr #0 {
start:
...
define void @_ZN6probe65probe17h23fd120fca49d995E() unnamed_addr #1 {
start:
; call core::f64::<impl f64>::is_subnormal
  %_1 = call zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17h89c3482fc679046dE"(double 1.000000e+00)
  ret void
}
